  ...
  <div>
    <table-template
      ...
      <el-form slot="add" style="overflow: auto" label-width="100px" :model="addForm">
        ...
        <el-form-item label="是否离职" prop="drivingRecord">
          <el-select v-model="addForm.drivingRecord" placeholder="请选择">
            <el-option
        ...
        <div v-if="addForm.drivingRecord === '是'">
      ...
      <el-form slot="edit" style="overflow: auto" label-width="100px" :model="editForm">
        ...
        <el-form-item label="是否离职" prop="drivingRecord">
          <el-select v-model="editForm.drivingRecord" placeholder="请选择">
            <el-option
              v-for="item in isQuitOption"
              :key="item.value"
              :label="item.label"
        ...
        <div v-if="editForm.drivingRecord === '是'">
          <el-form-item label="离职时间" prop="endTime">
            <el-date-picker
...
export default {
  ...
  data () {
    return {
      ...
      vehicleID: null,
      refreshObj: {},
      refreshUrl: 'drivingRecord/findAllDrivingRecord',
      addUrl: 'drivingRecord/addDrivingRecord',
      editUrl: 'drivingRecord/editDrivingRecord',
      deleteUrl: 'drivingRecord/deleteDrivingRecord',
      tableName: 'isQuitTable',
      tableTitle: '行驶记录', // 表格标题
      tablePK: 'id', // 主键id值
      tableHeaderList: [ // 表头字段
        {value: 'startTime', label: '入职时间', width: '160'},
        {value: 'drivingRecord', label: '是否离职', width: '100'},
      ...
      addForm: {vehicleId: '', drivingRecord: '', startTime: '', endTime: '', reasons: '', remarks: ''}, // 新增数据界面
