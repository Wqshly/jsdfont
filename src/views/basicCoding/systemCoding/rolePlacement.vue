    ...
    <table-template
      ...
      <el-form slot="add" style="overflow: auto" label-width="100px">
        <el-form-item label="名称: " :model="addForm" prop="name">
          <el-input v-model="addForm.name" placeholder="如:&nbsp;总经理、总经理助手等"></el-input>
        </el-form-item>
      </el-form>
      <!-- 编辑窗口 -->
