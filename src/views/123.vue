...
export default {
  ...
  data () {
    return {
      ...
      tableTitle: '供应商信息', // 表格标题
      tablePK: 'id', // 主键id值
      tableHeaderList: [ // 表头字段
        {value: 'number', label: '供应商编号', width: '120'},
        {value: 'name', label: '供应商名字', width: '120'},
        {value: 'abbreviation', label: '首字母缩写', width: '120'},
        {value: 'finalEditor', label: '修改人', width: '120'},
        {value: 'finalEditTime', label: '修改时间', width: '220'}
      ],
      addForm: {number: '', name: '', carNumber: ''}, // 新增数据界面
