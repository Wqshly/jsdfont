          ...
          <el-table-column v-for="tableHeader in tableHeaderList" :key="tableHeader.value" :prop="tableHeader.value"
            ...
            <template slot-scope="scope">
              ...
              <el-popover trigger="hover" placement="top">
                ...
                <template
                  v-if="tableHeader.value === 'signingTime' || tableHeader.value === 'entryIntoForceTime' || tableHeader.value === 'deadline' || tableHeader.value === 'startTime' || tableHeader.value === 'endTime' || tableHeader.value === 'createTime'">
                ...
                <template
                  v-if="tableHeader.value !== 'finalEditTime' && tableHeader.value !== 'signingTime' && tableHeader.value
                   !== 'entryIntoForceTime' && tableHeader.value !== 'deadline' && tableHeader.value !== 'startTime' && tableHeader.value
                    !== 'endTime' && tableHeader.value !== 'picPath' && tableHeader.value !== 'createTime'">
